        ...
        try:
            ...
            return {
                ...
                "confidence_level": (
                    ...
                    else "MEDIUM" if results.get("confidence", 0) > 0.4 else "LOW"
                ),
                ...
                "article_source": results.get("domain_info", {}).get(
                    "domain", "Unknown"
                ),
    ...
    def _format_factor_breakdown(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "live_news_similarity" in results:
            ...
            breakdown["live_checker"] = {
                ...
                "details": {
                    ...
                    "matching_stories_found": live_data.get(
                        "matching_stories_found", 0
                    ),
        ...
        if "named_entity_recognition" in results:
            ...
            breakdown["named_entities"] = {
                ...
                "weight": 0.10,
                "contribution": (0.1 if ner_data.get("total_entities", 0) > 2 else 0.5)
                * 0.10,
                "details": {
