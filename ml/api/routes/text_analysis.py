...
from api.schemas.responses import TextAnalysisResponse, BatchAnalysisResponse, AnalysisResult
...
async def analyze_batch_texts(request: BatchAnalysisRequest):
    ...
    try:
        ...
        total_processing_time = sum(result.get("processing_time_ms", 0) for result in results)
